 const MESES_NOM = [
  ...
  let registros = JSON.parse(localStorage.getItem('horas_extras') || '[]');
  ...
  function renderTabla() {
    ...
    const datos = filtro
      ? registros.filter(r => r.fecha.startsWith(filtro))
      : registros;
      ...
      <table style="width:100%;border-collapse:collapse;margin-top:1.25rem;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><strong>Q${totalExtras.toFixed(2)}</strong></td>
          </tr>
          <tr>
            <td colspan="3"><strong>Sueldo Base</strong></td>
            <td><strong>Q${SUELDO_BASE.toFixed(2)}</strong></td>
          </tr>
          <tr>
            <td colspan="3"><strong>Total a Pagar</strong></td>
            <td><strong style="color:#4ade80;font-size:1.1rem;">Q${totalPagar.toFixed(2)}</strong></td>
          </tr>
        </tbody>
      </table>
    `;
